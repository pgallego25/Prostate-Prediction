...
def CreateModel(input_shape1,input_shape2,channels,output):
    ...
    x = Dense(400,  name='predictions1', init = 'glorot_uniform',activation='relu')(output_vgg16_conv)
    x = Dense(200,  name='predictions2', init = 'glorot_uniform',activation='relu')(x)
    x = Dense(100,  name='predictions3', init = 'glorot_uniform',activation='relu')(x)
    x = Dense(50,  name='predictions4', init = 'glorot_uniform',activation='relu')(x)
    x = Dense(output,  name='predictions5', init = 'glorot_uniform',activation = 'relu')(x)
   ...
   # adam = optimizers.Adam(lr=0.001, beta_1=0.9, beta_2=0.999, epsilon=None, decay=1e-2, amsgrad=False)
